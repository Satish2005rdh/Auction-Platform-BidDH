...
<head>
  ...
  <style>
    ...
    * {
    ...
    .data-table tbody td:nth-child(5):contains("Yes") {
      color: var(--success);
    }

    .data-table tbody td:nth-child(5):contains("No") {
      color: var(--danger);
    }
    ...
    <table class="data-table">
      ...
      <tbody>
        ...
        while ($row = mysqli_fetch_array($Result)) {
          echo "<tr>";
          echo "<td>";
          echo "<img style='width:100px;height:100px' src='../ProductPhoto/" . $row['Image'] . "'>";
          echo "</td>";
          echo "<td>";
          ...
          echo "<td>";
        ?>
          <a href="javascript:bid(<?php echo $row[0]; ?>)"><h6>Click to delete</h6> </a>
        <?php
