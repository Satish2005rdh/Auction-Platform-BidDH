...
<head>
  ...
  <link rel="stylesheet" type="css" href="../CSS/AddAdmin.css">
    ...
    <form class="register-form" method="POST" name="AAdmin">
      <div class="row">
        <div class="col-md-4 col-sm-4 col-lg-4">
          ...
          <input type="submit" class="btn btn-default regbutton" onclick=" return validadmin();"><br>
        </div>
      </div>
